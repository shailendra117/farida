...
const footerColumns = [
  ...
  },
  {
    ...
    links: ["Shipping Policy", "Refund Policy", "Privacy Policy", "FAQ", "Contact Us"].map(
      (label) => ({ label, to: "#" })
    ),
  },
  {
    ...
    <footer className="bg-gray-50 border-t border-gray-200 my-12">
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="hidden lg:grid grid-cols-4 gap-10">
          {/* Column 1 */}
          <div>
            <h4 className="text-xs sm:text-sm font-bold tracking-[0.2em] uppercase text-gray-800 mb-5">
            ...
            <ul className="space-y-2">
              {discoverLinks.map((link) => (
                <li key={link.label}>
                  {link.to === "#" ? (
                    <a href="#" className="text-sm sm:text-base hover:text-[#7B1D2A]">
                      {link.label}
                    </a>
                  ) : (
                    <Link to={link.to} className="text-sm sm:text-base hover:text-[#7B1D2A]">
                      {link.label}
                    </Link>
                  )}
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" className="flex items-center gap-3 text-sm sm:text-base hover:text-[#7B1D2A]">
          ...
          <div>
            ...
            <div className="space-y-6 text-sm sm:text-base break-words">
              <div>
                <p className="font-semibold mb-2">For Product Queries:</p>
                <p>
                ...
                <p>Timing: 9:30 AM – 6:00 PM (IST)</p>
                <p>Monday – Saturday</p>
              </div>
              <div>
                <p className="font-semibold mb-2">For Careers & HR Related Queries:</p>
                <p>
      ...
      {/* Copyright */}
      <p className="text-center text-sm sm:text-sm text-black tracking-wide py-4  shadow-lg">
