...
const footerColumns = [
  ...
  {
    title: "Follow Us",
    links: ["Facebook", "Instagram", "Pinterest", "X", "Youtube"].map(
      (label) => ({
        label,
        to: "#",
      }),
    ...
    <footer className="bg-gray-50 border-t border-gray-200 my-12">
      <div className="w-full max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="block lg:hidden">
          <FooterAccordionItem title="Let Us Help You">
            ...
            <div className="space-y-6 text-sm sm:text-base break-words">
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-700">
                  Phone:{" "}
                  <a href="tel:+918287567567" className="hover:underline">
                    +91 8287-567-567
                  </a>
                </p>
                <p className="text-sm text-gray-700">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">
                  Email:{" "}
                  <a
                    href="mailto:people@faridagupta.com"
                    className="hover:underline"
                  >
                    people@faridagupta.com
                  </a>
                </p>
              </div>
            </div>
